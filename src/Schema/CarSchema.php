 ...
 *
 * Отсюда их берут и миграции (при создании колонок), и формы слоя ввода
 * (при проверке запроса). До появления этого класса границы жили в двух
 * местах: миграция объявляла varchar(255) и numeric(12,2), а проверка
 * покрывала лишь часть из них — всё непокрытое доходило до PostgreSQL и
 * возвращалось клиенту как HTTP 500 вместо 422.
 *
